...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`atguigu` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `t_department` (
  ...
  `dname` varchar(20) NOT NULL COMMENT '员工名称',
...
insert  into `t_department`(`did`,`dname`,`description`) values 
(1,'研发部','负责研发工作'),
(2,'人事部','负责人事管理工作'),
(3,'市场部','负责市场推广工作'),
(4,'财务部','负责财务管理工作'),
...
CREATE TABLE `t_employee` (
  ...
  `work_place` set('北京','深圳','上海','武汉') NOT NULL DEFAULT '北京' COMMENT '工作地点',
  `hiredate` date NOT NULL COMMENT '入职日期',
  `job_id` int(11) DEFAULT NULL COMMENT '职位编号',
  `mid` int(11) DEFAULT NULL COMMENT '领导编号',
...
insert  into `t_employee`(`eid`,`ename`,`salary`,`commission_pct`,`birthday`,`gender`,`tel`,`email`,`address`,`work_place`,`hiredate`,`job_id`,`mid`,`did`) values 
(1,'孙洪亮',28000,0.65,'1980-10-08','男','13789098765','shl@atguigu.com','白庙村西街','北京,深圳','2011-07-28',1,1,1),
...
CREATE TABLE `t_job` (
  `jid` int(11) NOT NULL AUTO_INCREMENT COMMENT '职位编号',
  `jname` varchar(20) NOT NULL COMMENT '职位名称',
...
insert  into `t_job`(`jid`,`jname`,`description`) values 
(1,'技术总监','负责技术指导工作'),
(2,'项目经理','负责项目管理工作'),
(3,'程序员','负责开发工作'),
(4,'测试员','负责测试工作'),
